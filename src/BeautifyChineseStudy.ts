...
class BeautifyChineseStudy extends HTMLElement {
	...
	private conditionallyRenderColourSchemes (questionType: string): void {
		let body: HTMLElement = this.shadowRoot.querySelector('#anki-background');
		let card: HTMLElement = this.shadowRoot.querySelector('#chinese-card');
		let cardType: HTMLElement = this.shadowRoot.querySelector('#chinese-card-type');
		let cardContent: HTMLElement = this.shadowRoot.querySelector('#chinese-card-content');
	...
	createStrokeOrderCharacter() {
		...
		let charactersValue: string = this.shadowRoot.querySelector('#character-value').innerHTML;
		let characters: Array<string> = charactersValue.split('');
		let drawingArea: HTMLElement = this.shadowRoot.querySelector('#stroke-order');
