...
Anki utilizes web technologies to generate its flashcards. This codebase is using a web technology called Web Components that will allows users to only add three html tags to their Anki card templates and the rest is handled by automatically.
* `style`
